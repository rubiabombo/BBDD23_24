...
import gestionCentroEducativo.controller.ControladorTipologiaSexo;
...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		try {
			...
			sexos = ControladorTipologiaSexo.allRegisters();
	...
	public void setApellido(String apellido) {
		jtfApellido1.setText(apellido);
	}

	public void setSegundoApellido(String apellido) {

		jtfApellido2.setText(apellido);
